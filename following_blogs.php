<?php
    ...
    if (!isset($_SESSION['user'])) {
        header("Location: login.php?msg=Login to access this page..!&color=alert-danger");
        exit();
    }
    ...
    General::site_header("Following Blogs");
...
?>
       ...
       <!-- Blog Listing Page -->
        <section class="container py-5">
            ...
            <div class="row mb-4">
              <div class="col-lg-8">
                <h2 class="fw-bold"><i class="fa-solid fa-blog"></i> Following Blogs</h2>
              </div>
              <div class="col-lg-4">
    ...
    <script>
        ...
        function load_blogs(page = 1, search = '') {
          ...
          ajax_request.open("GET", "ajax/blog_process_user.php?action=load_folowing_blogs&page=" + page + "&search=" + search, true);
          ajax_request.send();
      }
